...
class MainForm: dfl.form.Form
{
	...
	private void initializeMainForm()
	{
		...
		//~DFL Form
		text = "TaskWatch";
		clientSize = dfl.all.Size(532, 254);
		...
		pnlInterrupt.bounds = dfl.all.Rect(0, 0, 532, 40);
		...
		txtDurInterrupt.bounds = dfl.all.Rect(64, 0, 192, 40);
		...
		btnCopy.text = "Copy";
		btnCopy.bounds = dfl.all.Rect(256, 0, 48, 40);
		...
		spacer2.bounds = dfl.all.Rect(304, 0, 16, 40);
		...
		btnConfig.bounds = dfl.all.Rect(448, 0, 32, 40);
		...
		grpTasks.text = "Tasks";
		grpTasks.bounds = dfl.all.Rect(0, 40, 532, 214);
		...
		taskPanels.bounds = dfl.all.Rect(9, 24, 514, 181);
